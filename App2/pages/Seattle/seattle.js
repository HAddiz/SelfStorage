...
(function () {
    "use strict";
    var items = [];
    WinJS.UI.Pages.define("/pages/Seattle/seattle.html", {
    ...
    WinJS.Namespace.define("Seattle.ListView", {
